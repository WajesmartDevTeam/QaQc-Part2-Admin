    ...
    <div class="md-layout">
      <div class="md-layout-item md-size-50">
        <md-field class="filter">
          ...
          <md-input type="month" v-model="selectedPeriod" required></md-input>
        </md-field>
      </div>
      <div class="md-layout-item md-size-50">
        <br />
      ...
      >
        <stats-card data-background-color="blue">
          ...
          <template slot="footer" class="md-alignment-right">
      ...
      >
        <stats-card data-background-color="green">
          ...
          <template slot="footer" class="md-alignment-right">
            <div class="stats" v-html="no_of_compliant"></div>
          </template>
        </stats-card>
      </div>
      <div
      ...
      >
        <stats-card data-background-color="purple">
          ...
          <template slot="footer" class="md-alignment-right">
            <div class="stats" v-html="no_of_uncompliant"></div>
          </template>
        </stats-card>
      </div>
      <div
          ...
          >
            ...
            >
              <md-table-row slot="md-table-row" slot-scope="{ item }">
                ...
                <md-table-cell md-label="Store"
                  >{{ item.address }}, {{ item.location }}</md-table-cell
                >
                <md-table-cell md-sort-by="visited" md-label="Visit Status">
                  <md-button
      ...
      >
        <md-card>
         ...
         overflow-y: auto;"
          >
            <md-table v-model="top_stores" table-header-color="green">
              <md-table-row slot="md-table-row" slot-scope="{ item }">
      ...
      >
        <md-card>
          ...
          <md-card-content
           ...
           overflow-y: auto;"
          >
            <md-table v-model="least_stores" table-header-color="red">
              <md-table-row slot="md-table-row" slot-scope="{ item }">
                <md-table-cell md-label="Store Name">{{
                  item.store_name
                }}</md-table-cell>
        ...
        <md-card v-if="no_form == false">
          ...
          <md-card-content
            style="height: 600px;
             overflow-y: auto;"
          >
            <md-table v-model="forms" table-header-color="orange">
              <md-table-row slot="md-table-row" slot-scope="{ item }">
                <md-table-cell md-label="ID">{{
                ...
                <md-table-cell md-label="Action">
                  <a
                    ...
                    v-bind:href="
                      'scoredreportview/' + item.store_id + '/' + selectedPeriod
                    "
                  >
