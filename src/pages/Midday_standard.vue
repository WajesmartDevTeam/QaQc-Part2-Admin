              ...
              >
                ...
                <md-table-cell md-label="Action">
                  <md-button class="md-raised md-warning">
                    <a v-bind:href="'midopeningsoaview/' + item.form_id">
                      <md-icon>dvr</md-icon>
                    </a>
                  </md-button>
                </md-table-cell>
  ...
  methods: {
    getStats () {
      ...
      this.$socket
        ...
        .then(response => {
          if (response.type == "middaysoa") {
            if (this.role == "storeManager") {
              this.no_of_forms = this.$store.getters.store_reports.MidStandardOperation.FormsSubmitted;
              this.no_of_stores = this.$store.getters.store_reports.MidStandardOperation.Visits;
